...
class ASeleniumLogin_1(unittest.TestCase):
    ...
    def test_005_FillingMeetingForm(self):
        ...
        time.sleep(2)
        responsibleName = driver.find_element_by_xpath('//body[@id="ui-id-1"]/span/span/span/input').send_keys('яip' + Keys.ENTER)
    ...
    def test_007_FindAndEditMeeting(self):
        ...
        project = driver.find_element_by_css_selector("div.input-group.search-field > input.form-control").send_keys('Selenium')
        time.sleep(1)
